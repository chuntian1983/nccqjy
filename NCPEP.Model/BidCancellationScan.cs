/**
* BidCancellationScan.cs
*
* 类 名： BidCancellationScan
*
* Ver    变更日期            负责人           变更内容
* ───────────────────────────────────
...
{
	/// <summary>
	/// BidCancellationScan:实体类(属性说明自动提取数据库字段的描述信息)
	/// </summary>
	[Serializable]
	public partial class BidCancellationScan
	{
		public BidCancellationScan()
		{}
		#region Model
		private int _id;
