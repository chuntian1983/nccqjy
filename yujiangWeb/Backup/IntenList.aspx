<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="IntenList.aspx.cs" Inherits="Web.IntenList" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
 <link type="text/css" href="Styles/pagination.css" rel="stylesheet" />
    ...
    <script src="Scripts/IntenList.js" type="text/javascript" language="javascript"></script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
 ...
 <div id="showLoad" style="display: none; position: absolute; top: 0%; left: 0%; width: 100%;
    ...
    <div class="tz wz">
        位置：<a href="Default.aspx">首页</a> >> <span id="lbl_List_TypeName"></span>
    </div>
    <div class="list ">
        <span id="lblIntenList"></span>
        <div>
