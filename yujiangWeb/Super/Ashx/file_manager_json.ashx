...
public class FileManager : IHttpHandler
{
    public void ProcessRequest(HttpContext context)
    {
        ...
        if (!Directory.Exists(HttpContext.Current.Server.MapPath(rootUrl)))
        {
            Directory.CreateDirectory(HttpContext.Current.Server.MapPath(rootUrl));
        }
