<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PropertyType.aspx.cs" Inherits="Web.Super.Dic.PropertyType" %>
...
<head id="Head1" runat="server">
    ...
    <script src="../Scripts/PropertyType.js" type="text/javascript" language="javascript"></script>
</head>
        ...
        <table class="tb" border="0px" cellpadding="0" cellspacing="0">
            <tr>
                <td style="width: 100px" height="43">
                     产权类型名称<span style="color: Red;">*</span>
                </td>
                <td>
                    <input type="text" name="PropertyTypeName" id="txtPropertyTypeName" maxlength="100" class="easyui-validatebox"
                        style="width: 200px;" missingmessage="产权类型名称必须填写" data-options="required:true,validType:'length[2,10]'" />
                </td>
            </tr>
            <tr>
