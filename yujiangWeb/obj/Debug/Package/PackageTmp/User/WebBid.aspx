<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebBid.aspx.cs" Inherits="Web.User.WebBid" %>
...
<head id="Head1" runat="server">
    ...
    <script src="../super/Scripts/easyUI/locale/easyui-lang-zh_CN.js" type="text/javascript"
        language="javascript"></script>
    <script src="../super/Scripts/WebBid.js" type="text/javascript" language="javascript"></script>
</head>
<body class="easyui-layout">
    <div region="north"  split="true" style="height: 370px; border: 0px;"
        border="false">
        <table id="tdg">
        </table>
    </div>
