...
namespace NCPEP.Dal
{
    ...
    public partial class T_JBONE
    {
        ...
        public bool Exists(int sid)
        {
            ...
            strSql.Append("select count(1) from T_JBONE");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into T_JBONE(");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update T_JBONE set ");
        ...
        public bool Delete(int sid)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from T_JBONE ");
            strSql.Append(" where sid=@sid");
            SqlParameter[] parameters = {
					new SqlParameter("@sid", SqlDbType.Int,4)
			};
        ...
        public NCPEP.Model.T_JBONE GetModel(int sid)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 sid,bid,tid,jbyhm,jbjg,jbdj,zbzt,beizhu,jbbs from T_JBONE ");
            strSql.Append(" where sid=@sid");
            SqlParameter[] parameters = {
					new SqlParameter("@sid", SqlDbType.Int,4)
			};
        ...
        /// 得到一个对象实体
        /// </summary>
        public NCPEP.Model.T_JBONE DataRowToModel(DataRow row)
        {
            NCPEP.Model.T_JBONE model = new NCPEP.Model.T_JBONE();
            if (row != null)
            {
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from T_JBONE T ");
