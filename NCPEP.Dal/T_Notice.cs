...
namespace NCPEP.Dal
{
    ...
    public partial class T_Notice
    {
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(NCPEP.Model.T_Notice model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into T_Notice(");
            strSql.Append("newsid,beizhu)");
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(NCPEP.Model.T_Notice model)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        /// 得到一个对象实体
        /// </summary>
        public NCPEP.Model.T_Notice GetModel(int id)
        {

            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 id,newsid,beizhu from T_Notice ");
            strSql.Append(" where id=@id");
            SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
            ...
            NCPEP.Model.T_Notice model = new NCPEP.Model.T_Notice();
        ...
        /// 得到一个对象实体
        /// </summary>
        public NCPEP.Model.T_Notice DataRowToModel(DataRow row)
        {
            NCPEP.Model.T_Notice model = new NCPEP.Model.T_Notice();
            if (row != null)
            {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select id,newsid,beizhu ");
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" id,newsid,beizhu ");
            strSql.Append(" FROM T_Notice ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
