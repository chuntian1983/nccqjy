...
namespace NCPEP.Dal
{
    ...
    public partial class T_hzs
    {
        ...
        public bool Exists(int id)
        {
            ...
            strSql.Append("select count(1) from T_hzs");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into T_hzs(");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update T_hzs set ");
            strSql.Append("xh=@xh,");
        ...
        public bool Delete(int id)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from T_hzs ");
            strSql.Append(" where id=@id");
            SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
        ...
        /// 得到一个对象实体
        /// </summary>
        public NCPEP.Model.T_hzs GetModel(int id)
        {

            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 id,xh,quyu,mingcheng,dizhi,zhuceshijian,jingyingfanwei,chengyuanshu,nianshouru,lishizhang,lianxidianhua,pinpaiqingkuang,niandujibie,zuzhicode,zuobiaox,zuobiaoy from T_hzs ");
            strSql.Append(" where id=@id");
            SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
        ...
        /// 得到一个对象实体
        /// </summary>
        public NCPEP.Model.T_hzs DataRowToModel(DataRow row)
        {
            NCPEP.Model.T_hzs model = new NCPEP.Model.T_hzs();
            if (row != null)
            {
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from T_hzs T ");
