...
namespace NCPEP.Dal
{
    ...
    public partial class T_SysFun
    {
        ...
        public bool Exists(int NodeId)
        {
            ...
            strSql.Append("select count(1) from T_SysFun");
        ...
        public int Add(NCPEP.Model.T_SysFun model)
        {
            ...
            strSql.Append("DisplayName,NodeURL,DisplayOrder,ParentNodeId,FunImgNum,Editor,CreateDate)");
            ...
            parameters[4].Value = model.FunImgNum;
        ...
        public bool Delete(int NodeId)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from T_SysFun ");
            strSql.Append(" where NodeId=@NodeId");
            SqlParameter[] parameters = {
					new SqlParameter("@NodeId", SqlDbType.Int,4)
			};
        ...
        public NCPEP.Model.T_SysFun GetModel(int NodeId)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 NodeId,DisplayName,NodeURL,DisplayOrder,ParentNodeId,FunImgNum,Editor,CreateDate from T_SysFun ");
            strSql.Append(" where NodeId=@NodeId");
            SqlParameter[] parameters = {
					new SqlParameter("@NodeId", SqlDbType.Int,4)
			};
            ...
            NCPEP.Model.T_SysFun model = new NCPEP.Model.T_SysFun();
        ...
        /// 得到一个对象实体
        /// </summary>
        public NCPEP.Model.T_SysFun DataRowToModel(DataRow row)
        {
            NCPEP.Model.T_SysFun model = new NCPEP.Model.T_SysFun();
            if (row != null)
            {
                ...
                if (row["FunImgNum"] != null)
                {
                    model.FunImgNum = row["FunImgNum"].ToString();
                }
                if (row["Editor"] != null)
                {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select NodeId,DisplayName,NodeURL,DisplayOrder,ParentNodeId,FunImgNum,Editor,CreateDate ");
            strSql.Append(" FROM T_SysFun ");
            if (strWhere.Trim() != "")
            {
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" NodeId,DisplayName,NodeURL,DisplayOrder,ParentNodeId,FunImgNum,Editor,CreateDate ");
            strSql.Append(" FROM T_SysFun ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from T_SysFun T ");
