...
namespace NCPEP.Dal
{
    ...
    public partial class T_NewsType
    {
        ...
        public bool Delete(int Id)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from T_NewsType ");
            strSql.Append(" where Id=@Id");
            SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)
			};
        ...
        public NCPEP.Model.T_NewsType GetModel(int Id)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 Id,NewsTypeName,Editor,CreateDate from T_NewsType ");
            strSql.Append(" where Id=@Id");
            SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)
			};
            ...
            NCPEP.Model.T_NewsType model = new NCPEP.Model.T_NewsType();
        ...
        /// 得到一个对象实体
        /// </summary>
        public NCPEP.Model.T_NewsType DataRowToModel(DataRow row)
        {
            NCPEP.Model.T_NewsType model = new NCPEP.Model.T_NewsType();
            if (row != null)
            {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select Id,NewsTypeName,Editor,CreateDate ");
            strSql.Append(" FROM T_NewsType ");
            if (strWhere.Trim() != "")
            {
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" Id,NewsTypeName,Editor,CreateDate ");
            strSql.Append(" FROM T_NewsType ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(1) FROM T_NewsType ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
            }
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from T_NewsType T ");
