<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Change.aspx.cs" Inherits="Web.Super.VerMana.Change" %>
...
<head id="Head1" runat="server">
    ...
    <script src="../Scripts/Change.js" type="text/javascript" language="javascript"></script>
</head>
<body class="easyui-layout">
    <div region="north" title="标变更信息列表" split="true" style="height: 415px; border: 0px;"
        border="false">
        &nbsp;&nbsp;标的名称：
    ...
    <div id="center" region="center" title="附件信息" >
        <table id="Scan">
        </table>
    </div>
