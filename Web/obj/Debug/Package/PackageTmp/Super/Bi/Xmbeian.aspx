<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Xmbeian.aspx.cs" Inherits="Web.Super.Bi.Xmbeian" %>
...
<head id="Head1" runat="server">
    ...
    <script src="../Scripts/Xmbeian.js" type="text/javascript" language="javascript"></script>
    
</head>
<body class="easyui-layout">
    <div region="center" title="项目备案信息列表" split="true" style="overflow: hidden; border: 0px;" border="false">
          <div id="tool">
        &nbsp;&nbsp;产权名称：
