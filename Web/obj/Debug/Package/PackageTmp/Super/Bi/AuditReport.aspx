<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AuditReport.aspx.cs" Inherits="Web.Super.Bi.AuditReport" %>
...
<%--    <script src="../Scripts/AuditReport.js" type="text/javascript" language="javascript"></script>--%>
...
{ field: 'DepaStatusId', title: '分管部门编号', width: 80, align: 'left', sortable: true, hidden: true }
        ...
        '-', {
            ...
            handler: function () {
                ...
                if (rows.length > 0) {
                    $('#BidScan').window('open');
                    $("#BidScanPage").attr("src", "../wh/hetongfj.aspx?p=" + rows[0].Id);
                } else {
                    msgShow("提示", "您还没有选中一列信息？", "question");
                }
            }
...
<body class="easyui-layout">
    ...
    <div id="BidPla" title="招标公告" class="easyui-window" modal="true" collapsible="false"
        ...
        <table width="98%">
            <tr>
                <td align="center">
                    <span id="txtBidPlacardTitle"></span>
                    <hr />
                </td>
            </tr>
            <tr>
                <td>
                    <span id="txtBidPlacardContent"></span>
                </td>
            </tr>
        </table>
    </div>
