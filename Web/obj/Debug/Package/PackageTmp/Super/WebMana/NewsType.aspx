<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewsType.aspx.cs" Inherits="Web.Super.WebMana.NewsType" %>
...
<head id="Head1" runat="server">
    ...
    <script src="../Scripts/newstype.js" type="text/javascript" language="javascript"></script>
</head>
        ...
        <table class="tb" border="0px" cellpadding="0" cellspacing="0">
            <tr>
                <td style="width: 100px" height="43">
                    新闻类型名称<span style="color: Red;">*</span>
                </td>
                <td>
                    <input type="text" name="NewsTypeName" id="txtNewsTypeName" maxlength="100" class="easyui-validatebox"
                        style="width: 200px;" missingmessage="新闻类型名称必须填写" data-options="required:true,validType:'length[1,10]'" />
                </td>
            </tr>
            <tr>
