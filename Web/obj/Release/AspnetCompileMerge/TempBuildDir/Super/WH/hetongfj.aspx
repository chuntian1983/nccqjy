<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="hetongfj.aspx.cs" Inherits="Web.Super.WH.BidClinchScan" %>
                ...
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="名称">
                            ...
                            <ItemTemplate>
                                <a  target="_blank" href='../Scan/htscan/<%#Eval("FK_BidId")%>/<%#Eval("ScanUrl") %>'><asp:Label ID="Label1" runat="server"><%#Eval("ScanName")%></asp:Label></a> 
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField>
