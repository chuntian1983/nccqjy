<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AttContractNo.aspx.cs"
    Inherits="Web.Super.Bi.AttContractNo" %>
...
<head id="Head1" runat="server">
    ...
    <script src="../Scripts/AttContractNo.js" type="text/javascript" language="javascript"></script>
</head>
<body class="easyui-layout">
    ...
    <div id="ScanImg" title="附件查看" class="easyui-window" modal="true" collapsible="false"
        minimizable="false" maximizable="false" icon="icon-save" style="width: 900px;
        height: 480px; padding: 5px; background: #fafafa;">
        <iframe id="showScanImg" scrolling="auto" frameborder="0" style="width: 850px; height: 430px;">
        </iframe>
    </div>
    ...
    <div id="BidScan" title="标成交附件" class="easyui-window" collapsible="false" minimizable="false"
        ...
        <iframe id="BidScanPage" scrolling="no" frameborder="0" style="width: 100%; height: 100%;">
        </iframe>
    </div>
    ...
    <div id="WinBidContractScan" title="合同附件" class="easyui-window" collapsible="false"
        minimizable="false" maximizable="false" style="width: 500px; height: 400px; padding: 5px;
        background: #fafafa;">
