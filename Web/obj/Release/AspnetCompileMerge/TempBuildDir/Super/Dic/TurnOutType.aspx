<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TurnOutType.aspx.cs" Inherits="Web.Super.Dic.TurnOutType" %>
...
<head id="Head1" runat="server">
    ...
    <script src="../Scripts/TurnOutType.js" type="text/javascript" language="javascript"></script>
</head>
        ...
        <table class="tb" border="0px" cellpadding="0" cellspacing="0">
            <tr>
                <td style="width: 100px" height="43">
                     转出方式名称<span style="color: Red;">*</span>
                </td>
                <td>
                    <input type="text" name="TurnOutTypeName" id="txtTurnOutTypeName" maxlength="100" class="easyui-validatebox"
                        style="width: 200px;" missingmessage="转出方式名称必须填写" data-options="required:true,validType:'length[2,50]'" />
                </td>
            </tr>
            <tr>
