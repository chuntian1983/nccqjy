<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StandardType.aspx.cs" Inherits="Web.Super.Dic.StandardType" %>
...
<head id="Head1" runat="server">
    ...
    <script src="../Scripts/StandardType.js" type="text/javascript" language="javascript"></script>
</head>
<body class="easyui-layout" style="overflow-y: hidden" scroll="no">
    ...
    <div id="newAdd" class="easyui-window" modal="true" collapsible="false" minimizable="false" maximizable="false"
        icon="icon-save" style="width: 800px; height: 150px; padding: 5px; background: #fafafa;">
        <form id="forms" runat="server">
        <table class="tb" border="0px" cellpadding="0" cellspacing="0">
            <tr>
                <td style="width: 100px" height="43">
                     挂牌类型名称<span style="color: Red;">*</span>
                </td>
                <td>
                    <input type="text" name="StandardTypeName" id="txtStandardTypeName" maxlength="100" class="easyui-validatebox"
                        style="width: 500px;" missingmessage="挂牌类型名称必须填写" data-options="required:true,validType:'length[2,10]'" />
                </td>
            </tr>
            <tr>
