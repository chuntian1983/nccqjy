<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TranAcc.aspx.cs" Inherits="Web.Super.Bi.TranAcc" %>
...
<head id="Head1" runat="server">
   ...
   <%-- <script src="../Scripts/TranAcc.js" type="text/javascript" language="javascript"></script>--%>
...
{ field: 'DepaStatusId', title: '分管部门编号', width: 80, align: 'left', sortable: true, hidden: true }
                ...
                '-', {
                    ...
                    handler: function () {
                        ...
                        if (rows.length > 0) {
                            $('#divopen').window('open');
                            $("#divopen2").attr("src", "../dzjj/yxsrf.aspx?p=" + rows[0].Id);
                        }
                        else {
                            msgShow("提示", "您还没有选中要更改的列信息？", "question");
                        }
...
<body class="easyui-layout">
    ...
    <div id="newAdd" title="出让标详细信息" class="easyui-window" modal="true" collapsible="false"
       ...
       <div id="ReturnInfo" title="退回审核原因" class="easyui-window" collapsible="false" minimizable="false"
        ...
        <table>
            <tr>
                <td>
                    <textarea id="txtReturnDepaSay" name="ReturnDepaSay" style="width: 350px; height: 70px;" class="easyui-validatebox"
                        missingmessage="必须填写" required="true"></textarea>
                </td>
            </tr>
            <tr align="center">
    ...
    <div id="divopen" title="意向受让方信息" class="easyui-window" collapsible="false" minimizable="false"
        maximizable="false" style="width: 700px; height: 400px; padding: 5px; background: #fafafa;">
        <iframe name="divopen2" id="divopen2" scrolling="no" frameborder="0" style="width: 100%;
            height: 100%;"></iframe>
    </div>
</body>
</html>
