...
{ field: 'LiceTranType', title: '出让方', width: 80, align: 'left', sortable: true, formatter: function (value, row, index) { return row.LiceTranType == 1 ? "出让方" : "意向受让方"; } }
]],
                columns: [[
    ...
    <div id="newAdd" class="easyui-window" modal="true" collapsible="false" minimizable="false"
        ...
        <table width="640" class="tb" border="0px" cellpadding="0" cellspacing="0">
            <tr>
                ...
                <td colspan=3>
                    <select name="OrgCode" id="txtOrgCode" class="easyui-combotree" style="width: 280px;">
                    </select>
                </td>
