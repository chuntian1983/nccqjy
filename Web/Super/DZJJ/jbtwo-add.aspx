<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="jbtwo-add.aspx.cs" Inherits="Web.Super.DZJJ.jbtwo_add" %>
...
<body class="easyui-layout" style="overflow-y: hidden" scroll="no">
 <form  runat="server" id="form1">
    ...
    <div region="center" title="一次竞价信息设置" style=" overflow:auto;">
        ...
        <table class="table" border="0px" cellpadding="0" cellspacing="0">
            <tr>
                <td style="width: 200px" height="43">
                    一次竞价底价（元）<span style="color: Red;">**</span>
                </td>
                <td>
            ...
            <tr>
                <td height="43">
                    一次竞价时间<span style="color: Red;">**</span>
                </td>
                <td>
