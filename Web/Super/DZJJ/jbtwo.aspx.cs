...
{
    public partial class jbtwo : System.Web.UI.Page
    {
        ...
        private void BindDate()
        {
            ...
            //}
            //二次竞价
            sb.Append(" and DepaStatus='3' and StandardMode='3'");
        ...
        protected void rep_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                else if (lbjbzt.Text == "3")
                {
                    lbjbzt.Text = "二次竞标中";
                }
                else if (lbjbzt.Text == "4")
                {
                    lbjbzt.Text = "二次竞标完成";
                }
                else
        ...
        protected void btnedit_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                Response.Redirect("jbtwo-add.aspx?id=" + sysID + "");
            }
        }
        //一次结果选择
        ...
        protected void btnview_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                Response.Redirect("jbtwo-view.aspx?id=" + sysID + "");
            }
        }
        ...
        //二次结果选择
        protected void btntwoview_Click(object sender, EventArgs e)
        {
            int i = 0;
            string sysID = string.Empty;
            foreach (RepeaterItem row in this.rep.Items)
            ...
            else
            {
                ...
                Response.Redirect("jbtwo-overtwo.aspx?id=" + sysID + "");
            }
        }
        //二次结果查看
        protected void btntwojg_Click(object sender, EventArgs e)
        {
            int i = 0;
            string sysID = string.Empty;
            foreach (RepeaterItem row in this.rep.Items)
            ...
            else
            {
                ...
                Response.Redirect("jbtwo-viewtwo.aspx?id=" + sysID + "");
            }
        }
    }
}