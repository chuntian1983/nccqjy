...
{
    public partial class jbtwo_useryiciview : System.Web.UI.Page
    {
        ...
        private void BindDate()
        {
            ...
            //}
            sb.Append(" and jbbs='1' and bid='" + Request.QueryString["st"] + "' ");
        ...
        protected void btnjieguo_Click(object sender, EventArgs e)
        {
            ...
            {
                Response.Redirect("OneAgreejieguo.aspx?st=" + sysID);
