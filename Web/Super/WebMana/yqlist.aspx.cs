...
{
    public partial class yqlist : System.Web.UI.Page
    {
        ...
        private void BindDate()
        {
            ...
            {
                sb.Append(" and yqleixing='" + this.ddlxwlx.SelectedValue + "'");
            }
            if (!string.IsNullOrEmpty(this.TextBox1.Text))
            {
                sb.Append(" and yqname like '%" + this.TextBox1.Text + "%'");
            }
        ...
        protected void btnedit_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                Response.Redirect("yqadd.aspx?id=" + sysID + "");
            }
        }
