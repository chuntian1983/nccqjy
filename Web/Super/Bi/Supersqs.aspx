<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Supersqs.aspx.cs" Inherits="Web.Super.Bi.Supersqs" %>
...
<head id="Head1" runat="server">
    ...
    <script src="../Scripts/Supersqs.js" type="text/javascript" language="javascript"></script>
</head>
<body class="easyui-layout">
    <div region="north" title="打印申请信息" split="true" style="height: 415px; border: 0px;"
        border="false">
        &nbsp;&nbsp;标的名称：
