<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="list.aspx.cs" Inherits="Web.Super.hzs.list" %>
...
<div class="panel panel-default">
  <div class="panel-heading">合作社信息搜索</div>
  <div class="panel-body">
    
            合作社信息标题：<asp:TextBox ID="TextBox1" runat="server"></asp:TextBox>
...
<div class="panel panel-default">
  <div class="panel-heading">
    <h3 class="panel-title">合作社信息列表</h3>
  </div>
