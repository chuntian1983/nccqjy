<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="mapset.aspx.cs" Inherits="Web.Super.hzs.mapset" %>
...
<div class="panel-group"><div class=" text-info">当前合作社名称：<%=strname %> 地址：<%=this.hdzb.Value %>  注意：请用鼠标点击地图位置选择坐标点进行保存,如果默认没有搜索到位置请自行搜索查询</div><br />
